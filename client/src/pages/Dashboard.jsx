    ...
    <div className="min-h-screen bg-auth-bg">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-page-heading font-bold text-content-primary">My Notes</h1>
          ...
          <>
            ...
            {notes.length === 0 && (
              <div className="text-center py-20">
                ...
                <h3 className="text-task-label font-semibold text-content-primary mb-1">No notes yet</h3>
